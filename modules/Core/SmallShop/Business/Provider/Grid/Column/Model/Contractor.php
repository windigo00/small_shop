<?php
namespace Modules\Core\SmallShop\Business\Provider\Grid\Column\Model;

use App\Providers\Grid\Columns;
use App\Providers\Grid\Column\Type;
use Modules\Core\SmallShop\Business\Model\Contractor as ContractorModel;

/**
 * Description of ContractorGridColumns
 *
 * @author windigo
 */
class Contractor extends Columns
{
    public function initColumns(): void
    {
        ...
        $this->items = [
            ...
            app(Type\Text::class, [
                ...
                'render' => function ($value, ContractorModel $row) {
            ...
            app(Type\Action::class, [
                ...
                'actions' => [
                    ...
                    'delete' => [
                        ...
                        'confirm' => function (ContractorModel $item) use ($deleteQuestion) {
